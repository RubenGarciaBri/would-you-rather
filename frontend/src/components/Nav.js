    ...
    <nav className="navbar">
      <div className="navbar__container main-container">
          ...
          <ul className="navbar__left-list">
            ...
            <li className="navbar__left-list__item">
              ...
              >
                <MdAddCircle
                  size={24}
                  className="navbar__left-list__item-icon"
                />
          ...
          <ul className="navbar__right-list">
            <li className="navbar__right-list__item">
              <img
                ...
                alt="Logged user's avatar"
                className="navbar__right-list__item-img shadow-slim"
              />
              <span className="navbar__right-list__item-name">
                {authedUser.id}
              </span>
            </li>
            <li className="navbar__right-list__item">
              <Button
                className="navbar__right-list__item-logout"
                onClick={handleLogout}
              >
                <FaSignOutAlt
                  className="navbar__right-list__item-logout__icon"
                  size={18}
                />
              </Button>
            </li>
        ...
        <img
          src={authedUser.avatar}
          alt="Logged user's avatar"
          className="bars-userImg shadow-slim"
        />
        ...
        {activeSideMenu === true ? (
          <ul ref={node} className="sideNav shadow-slim">
            ...
            <li className="sideNav__item">
              <a
                className="sideNav__item-logout"
                href="#!"
                onClick={handleLogout}
              >
